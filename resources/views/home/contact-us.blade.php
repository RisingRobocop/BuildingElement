...
<div class="container m_top20 m_bot20 content">
	<div class="row m_top">
		<div class="col-sm-4 m_bot">
			...
			<div class="m_top20"><span class="form_button" data-toggle="modal" data-target="#contactModal">@lang('contact.write-us')</span></div>
		</div>
		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<form action='{{url('mail')}}' method="post">
					...
					<button type="submit" class="form_button m_top20">@lang('contact.send')</button>
				</form>
